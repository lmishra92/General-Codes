...
Vissim = com.dynamic.Dispatch("Vissim.Vissim-32.700")
# If you have installed muliple Vissim Versions, you can open a spcific Vissim version adding the bit Version (32 or 64bit) and Version number
